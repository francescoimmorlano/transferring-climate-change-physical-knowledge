...
gl1 = axs[0].gridlines(draw_labels=False, linestyle='--', linewidth=0.1, color='black')
...
cbar1 = fig.colorbar(cs1, shrink=0.8, ax=axs[0], ticks=cbarticks, orientation='horizontal', pad=0.08)
...
gl2 = axs[1].gridlines(draw_labels=False, linestyle='--', linewidth=0.1, color='black')
...
cbar2 = fig.colorbar(cs2, ax=axs[1], shrink=0.8, ticks=cbarticks, orientation='horizontal', pad=0.08)
...
gl3 = axs[2].gridlines(crs=ccrs.PlateCarree(), draw_labels=False, linestyle='--', linewidth=0.1, color='black')
...
cbar3 = fig.colorbar(cs3, shrink=0.8, ax=axs[2], orientation='horizontal', pad=0.08, ticks=cbarticks_3)
...
plt.text(x=0.13, y=0.89, s='A', fontweight='bold',
         fontsize=size_suptitlefig, ha="center", transform=fig.transFigure)
plt.text(x=0.395, y=0.89, s='B', fontweight='bold',
         fontsize=size_suptitlefig, ha="center", transform=fig.transFigure)
